...
- [`0.9.4`, `0.9.4-apache`, `apache`, `latest`](https://github.com/ckulka/baikal-docker/blob/0.9.4+msmtpfix/apache.dockerfile)
...
- [`0.9.4-nginx`, `nginx`](https://github.com/ckulka/baikal-docker/blob/0.9.4+msmtpfix/nginx.dockerfile)
